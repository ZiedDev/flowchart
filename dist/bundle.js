...
function addConnection(fromId, toId, attr='') {
    let cid = `${attr}${fromId}:${toId}`
...
function remConnection(fromId, toId, attr='') {
    let cid = `${attr}${fromId}:${toId}`
