...
function createFlowBlock(symbolType, id, content, draggable) {
    ...
    const elementDraggable = new plain_draggable__WEBPACK_IMPORTED_MODULE_0__["default"](document.getElementById(id))
