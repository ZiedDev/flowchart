...
function createLine(start, end, label = undefined, lineColor = undefined) {
    ...
    return new (leader_line_new__WEBPACK_IMPORTED_MODULE_1___default())(document.getElementById(start), document.getElementById(end),
        { startPlug: 'disc', size: 4, startPlugSize: 1.5, startPlugOutlineSize: 2.5, color: lineColor == undefined ? '#f0f8ff' : lineColor, path: 'fluid', dropShadow: true, middleLabel: leader_line_new__WEBPACK_IMPORTED_MODULE_1___default().pathLabel(labelObj) }) // 
}
class FlowBlock {
